...
SET @@character_set_client = 'gbk'; #大概率不加引号的结果是被识别为字段
...
(
	...
	contactor varchar(30) not null,
	mobile varchar(12) not null
)ENGINE=InnoDB DEFAULT CHARSET='gbk';

set names 'gbk';
insert into publisher(pub_name,contactor,mobile) values('清华大学出版社','尚小云','13588889999');
insert into publisher(pub_name,contactor,mobile) values('电子工业出版社','廖时飞','13588887777');
insert into publisher(pub_name,contactor,mobile) values('人民邮电出版社','宋凌枫','13588886666');
insert into publisher(pub_name,contactor,mobile) values('人民教育出版社','刘小纳','13588885555');
...
(
	...
	'period' int default 0,#语法冲突，同样加引号
